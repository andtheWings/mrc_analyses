...
```{r}
clustered_people <- read_parquet("data/mrc_people_model/clustered_people.parquet")
```
...
```{r}
referral_dests <- clustered_encounters %>% select(mrc_discharge_dest, discharge_dest_cat)
