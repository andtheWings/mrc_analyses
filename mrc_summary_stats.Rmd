...
```{r}
mrc_encounters <- mrc_discharge_dest <- all_raw %>%
    select(
        mrc_id = "Record ID",
...
mrc_encounters[60,3] = as_date("2021-03-27")
mrc_encounters[61,2] = "Rush Oak Park ED"
mrc_encounters[61,3] = as_date("2021-03-12")
mrc_encounters[62,2] = "Unknown"
mrc_encounters[62,3] = as_date("2021-03-09")
mrc_encounters[64,2] = "Housing Forward"
mrc_encounters[64,3] = as_date("2021-04-30")
mrc_encounters[67,2] = "Unknown"
mrc_encounters[67,3] = as_date("2021-05-23")
mrc_encounters[68,2] = "Stroger Hospital"
mrc_encounters[68,3] = as_date("2021-07-03")
mrc_encounters[70,2] = "Unknown"
mrc_encounters[70,3] = as_date("2021-09-09")
mrc_encounters[73,2] = "Unknown"
mrc_encounters[73,3] = as_date("2021-08-22")
```

Export to parquet file for use by python:

```{r}
write_parquet(mrc_encounters, "data/mrc_encounters_model/mrc_encounters.parquet")
```

Python takes the parquet file and uses the dedupe module to assign cluster ID's to repeat clients.

Import the clustered data back into R:

```{r}
clustered_mrc_encounters_raw <- read_parquet("data/mrc_encounters_model/clustered_mrc_encounters.parquet")
```
