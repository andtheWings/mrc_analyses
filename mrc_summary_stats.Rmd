...
use_condaenv(condaenv = "mrc_analyses", conda = "/home/riggins/miniconda3/bin/conda")
py_config()
conda_install(envname = "r_mrc_analyses", packages = "pyarrow")
...
```{r}
write_parquet(mrc_encounters, "data/mrc_people_model/mrc_encounters.parquet")
```


```{python}
os.chdir('/home/riggins/mrc_analyses/data/mrc_people_model')

mrc_encounters = pd.read_parquet("mrc_encounters.parquet")

mrc_clustered_people = dd.dedupe_dataframe(
        mrc_encounters,
        ['last_name', 'first_name', 'dob']
)

mrc_clustered_people.to_parquet('mrc_clustered_people.parquet')
```

```{r}
mrc_clustered_people <- py$mrc_clustered_people
```
