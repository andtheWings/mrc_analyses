...
Automate the generation of a summary table for every single variable of interest:
...
#     sheets = c(people_summary_names, referral_summary_names)
# )

purrr::map2(
    .x = people_summary_tables,
    .y = people_summary_names,
